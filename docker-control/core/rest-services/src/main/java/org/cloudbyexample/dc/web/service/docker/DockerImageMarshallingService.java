...
/**
 * Docker image marshalling service.
 *
 * @author David Winterfeldt
 */
public interface DockerImageMarshallingService  {

    public final static String PATH_DELIM = "/";

    final static String PATH = "/docker/image";

    public final static String FIND = PATH;
    public final static String BUILD = PATH + PATH_DELIM + "build";
